[@hanzo/matching-engine](../README.md) › [Globals](../globals.md) › ["utils/time"](_utils_time_.md)
...
*Defined in [utils/time.ts:3](https://github.com/hanzoai/matching-engine/blob/1c5df06/src/utils/time.ts#L3)*
